...
export const PAPERS: AcademicPaperData[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          "Intellectual honesty requires that BWB theory not become a romanticization of suffering. The bleed is real, and it kills. Practitioners of BWB-adjacent modes of creation — the undocumented artist, the incarcerated writer, the unhoused technologist — face statistically elevated rates of early death, [mental health crisis](unseen-war#psychological-harm), and permanent capability loss. The conditions that make the work urgent are the same conditions that make the work temporary.",
  ...
  },
  {
    ...
    authorNote: "This paper is the third in a series examining the folk devil as social infrastructure. The companion papers are \"[The Folk Devil as Social Infrastructure](folk-devil-infrastructure)\" (Borland, 2025a), which establishes the structural framework, and \"[Unseen War, Internal Wounds](unseen-war)\" (Borland, 2025d), which documents the clinical harm profile of coordinated destabilization campaigns. This paper focuses specifically on the differential effects of the folk devil position relative to normatively integrated citizen experience.",
    sections: [
      {
        id: 'intro',
        title: "Introduction",
      ...
      },
      {
        ...
        content: [
          ...
          "The second major harm produced by folk devil assignment is the development of [hypervigilance](unseen-war#psychological-harm) - the heightened sensory scanning of environments for pre-cognitive threat signals - and, critically, the weaponization of that adaptive response against the person who has developed it. For the assigned folk devil in an active targeting environment, hypervigilance is accurate threat detection. The campaign mechanism documented in the case literature exploits this by systematically framing accurate threat perception as evidence of instability."
        ]
      },
      {
        id: 'epistemology',
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          "The psychological harm inflicted by this campaign does not fit the standard trauma model built around discrete, bounded events. It is more accurately characterized as [complex PTSD](https://en.wikipedia.org/wiki/Complex_post-traumatic_stress_disorder) - the clinical profile produced not by a single catastrophic incident but by prolonged, inescapable, multi-directional threat with no available recovery environment. Every potential zone of safety was systematically contaminated. Social relationships were converted into surveillance assets. Physical spaces became exclusion zones. Institutions that are supposed to provide recourse were turned into additional vectors of harm.",
