...
export const PAPERS: AcademicPaperData[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          "Intellectual honesty requires that BWB theory not become a romanticization of suffering. The bleed is real, and it kills. Practitioners of BWB-adjacent modes of creation — the undocumented artist, the incarcerated writer, the unhoused technologist — face statistically elevated rates of early death, [[unseen-war#psychological-harm|mental health crisis]], and permanent capability loss. The conditions that make the work urgent are the same conditions that make the work temporary.",
  ...
  },
  {
    ...
    authorNote: "This paper is the first in a three-part series examining the folk devil as social infrastructure. The companion papers are \"[[unseen-war|Unseen War, Internal Wounds]]\" (Borland, 2025d), which documents the clinical harm profile of coordinated destabilization campaigns, and \"[[carried-weight|Carried Weight]]\" (Borland, 2025e), which examines the specific effects of the folk devil position relative to normatively integrated citizen experience. This paper establishes the structural and sociological framework for the series.",
    sections: [
      {
        id: 'intro',
        title: "Introduction",
        content: [
          "Stanley Cohen\'s 1972 analysis of the Mods and Rockers established the foundational vocabulary for the study of folk devils and [moral panics](https://en.wikipedia.org/wiki/Moral_panic): the amplification spiral, the moral entrepreneur, the disproportionate institutional response to a symbolically charged figure of threat. What Cohen identified was a sociology of overreaction - the mechanisms through which ordinary social deviance becomes the occasion for extraordinary social mobilization. The folk devil, in this formulation, is primarily the object of community anxiety, the screen onto which collective fear is projected and amplified through media and institutional feedback.",
          "This paper proposes a complementary but distinct analytical frame. The folk devil is not merely the object of community anxiety. In high-conflict, low-trust communities, the folk devil is [[bwb-theory#infrastructure|functional infrastructure]] - a mechanism that performs essential social work for the community that constructs it. Specifically, the folk devil performs the work of consensus generation in communities where normal consensus mechanisms have failed. Understanding the folk devil as infrastructure rather than merely as victim or symbol requires a structural analysis that the moral panic literature has not fully supplied.",
          "The structural question this paper addresses is: what are the mechanics through which the folk devil construction operates as a cohesion tool, and what does the community gain from its operation? The answer to this question has direct implications for understanding why folk devil constructions persist, why they are resistant to factual refutation, and why the individuals assigned to the folk devil position experience [[unseen-war#intro|harm that is, as the companion papers document, structurally produced rather than incidentally encountered]]."
        ]
      },
      {
        id: 'cohesion-deficit',
      ...
      },
      {
        ...
        content: [
          "The folk devil construction begins with [[unseen-war#architecture|outsider-coding]]: the attribution to a specific individual of a legible outsider identity that marks them as available for the targeting function. Outsider-coding does not require factual accuracy. It requires legibility - the availability of observable markers that the community can interpret as confirming outsider status. Housing instability, visible poverty, racial difference, unusual dress or behavior, the absence of recognized social affiliations - any of these can serve as the raw material for outsider-coding, depending on the community\'s particular interpretive frameworks.",
      ...
      },
      {
        ...
        content: [
          "The folk devil construction, once established, does not require active maintenance by any single orchestrating actor. It is maintained by the [[unseen-war#architecture|distributed social behavior]] of community participants who are individually motivated by social belonging (conformity to the ambient consensus), threat reduction (treating the folk devil as a genuine safety concern), and factional utility (using the folk devil as a zero-cost cohesion resource). Each of these motivations is individually comprehensible and, from the perspective of the individual actor, does not require bad faith or malicious intent.",
  ...
  },
  {
    ...
    authorNote: "This paper is the third in a series examining the folk devil as social infrastructure. The companion papers are \"[[folk-devil-infrastructure|The Folk Devil as Social Infrastructure]]\" (Borland, 2025a), which establishes the structural framework, and \"[[unseen-war|Unseen War, Internal Wounds]]\" (Borland, 2025d), which documents the clinical harm profile of coordinated destabilization campaigns. This paper focuses specifically on the differential effects of the folk devil position relative to normatively integrated citizen experience.",
    sections: [
      {
        id: 'intro',
        title: "Introduction",
      ...
      },
      {
        ...
        content: [
          ...
          "The first and most fundamental of these protections is [[bwb-theory#epistemology|interpretive charity]]: the default assumption, in the absence of specific counter-evidence, that the individual\'s conduct is benign. The second protection is institutional access: the ability to engage with formal institutions with a reasonable expectation of being received as a credible complainant rather than a suspect. The third protection is narrative authority: the social capacity to define oneself, to contest misrepresentations, and to have one\'s account of events considered on its merits."
        ]
      },
      {
        id: 'harm-profile',
        ...
        content: [
          ...
          "The second major harm produced by folk devil assignment is the development of [[unseen-war#psychological-harm|hypervigilance]] - the heightened sensory scanning of environments for pre-cognitive threat signals - and, critically, the weaponization of that adaptive response against the person who has developed it. For the assigned folk devil in an active targeting environment, hypervigilance is accurate threat detection. The campaign mechanism documented in the case literature exploits this by systematically framing accurate threat perception as evidence of instability."
        ]
      },
      {
        id: 'epistemology',
